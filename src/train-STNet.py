...
parser.add_argument('--output',type=str,default="../results/STNet",help='output folder path')
...
if __name__ == "__main__":
    ...
    model = models.densenet121(num_classes = train_adata.n_vars)
    state_dict = torch.load(os.path.join('../weights/DenseNet','densenet121.pth'))
